...
export const debugFieldTooltips = {
  LCP: {
    startTime: "Time (in ms) when the largest contentful element started rendering.",
    loadTime: "Duration (in ms) it took to fully load the largest contentful element.",
  ...
  INP: {
    ...
    processingStart: "Time (in ms) when the browser began processing the interaction event.",
    processingEnd: "Time (in ms) when the browser finished processing the interaction event.",
    navigationType: "How the page was loaded (navigate, reload, back/forward).",
  ...
  TTFB: {
    ...
    connectStart: "Timestamp when the browser began establishing the connection.",
    connectEnd: "Timestamp when the connection to the server was established.",
    secureConnectionStart: "Timestamp when the TLS/SSL handshake began (0 if not secure).",
    requestStart: "Timestamp when the request was sent to the server.",
    responseStart: "Timestamp when the first byte of the response was received.",
    ...
    encodedBodySize: "Compressed body size (in bytes) transferred over the network.",
    ...
    serverWait: "Time between sending the request and receiving the first byte (server wait).",
