...
const INPContainer = () => {
  ...
  useEffect(() => {
    ...
    setINPDebugInfo((debugInfo) => ({
      ...debugInfo,
      navigationType: webVitalsData['INP'].navigationType,
    }))
  ...
  return (
    <div className={styles.inpContainer}>
      <VitalHeadingContainer
        vitalType="INP"
        value={webVitalsData['INP'].value}
        description={DESCRIPTION_TEXT.INP}
      />
      <VitalMainIndicator
        good={200}
        poor={500}
      ...
      {webVitalsData['INP'].value >= 0 ? (
        <>
          ...
          <p className={styles.sectionDescription}>
            Click this section to highlight the element in page where the
            longest INP occurred.
          </p>
          <div
            className={styles.elementTypeContainer}
            onClick={highlightINPElement}
          >
